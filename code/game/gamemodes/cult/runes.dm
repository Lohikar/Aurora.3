...
/obj/effect/rune/proc/armor(var/mob/living/user)
	...
	if(istype(user, /mob/living/simple_animal/construct))
		...
		//the above update their overlay icons cache but do not call update_icon()
		//the below calls update_icon() at the end, which will update overlay icons by using the (now updated) cache
